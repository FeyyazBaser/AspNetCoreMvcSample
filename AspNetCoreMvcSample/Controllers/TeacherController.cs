...
namespace AspNetCoreMvcSample.Controllers
{
    public class TeacherController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,FirstName,LastName,Department")] Teacher teacher)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,FirstName,LastName,Department")] Teacher teacher)
        {
            if (id != teacher.Id)
            {
                return NotFound();
